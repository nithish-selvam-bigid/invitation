...
window.INVITE = {
  ...
  couple: {
    ...
    quote:
      "Bound not by ceremony alone, but by the quiet promise of every day that follows.",
  ...
  venue: {
    ...
    mapUrl:
      "https://www.google.com/maps/search/?api=1&query=Vettri+Krishnan+Mahal+West+Mambalam+Chennai",
  },
